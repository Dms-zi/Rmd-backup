...
ANDREAS MEULEMAN, ISHAAN SHAH, ALEXANDRE LANVIN,<br>
BERNHARD KERBL, GEORGE DRETTAKIS

.small[
ACM Transactions on Graphics (TOG), 2025  
[graphdeco-inria/on-the-fly-nvs](https://github.com/graphdeco-inria/on-the-fly-nvs)
]
...
<!-- Image/Table Placeholder -->
<br><br><br>
.caption[Fig: Process of calculating sampling probability (Images from media)]
...
<!-- Image/Table Placeholder -->
<br><br><br>
.caption[Fig: Depth estimation and Scale initialization]
...
<!-- Image/Table Placeholder -->
<br><br><br>
.caption[Fig. 5. Direct sampling to place new primitives during joint optimization]
...
## 단계 개요
*사전에 새 프레임에 대한 초기 pose가 추정되어있고, sampling으로 Gaussian 위치와 크기를 확보했다고 가정*
...
*Joint optimization을 통해 pose와 3DGS 표현이 정제 되어 이후 anchor 기반 대규모 처리에 사용*
...
<!-- Image/Table Placeholder -->
<br><br><br>
.caption[Table 2. Novel view quality results for different methods that require low-resolution input.]
...
<!-- Image/Table Placeholder -->
<br><br><br>
.caption[Fig. 9. Qualitative comparison of large-scale methods for the three datasets used.]

<!-- Image/Table Placeholder -->
<br><br><br>
.caption[Table 4. Results for large scale scenes]
...
<!-- Image/Table Placeholder -->
<br><br><br>
.caption[Table 6. Per keyframe runtime breakdown]

<!-- Image/Table Placeholder -->
<br><br><br>
.caption[Table 5. Pose estimation results for different methods using absolute and relative error metrics]
...
<!-- Image/Table Placeholder -->
<br><br><br>
.caption[Fig. 11. Qualitative evaluation of the various components via ablation studies on Garden.]

<!-- Image/Table Placeholder -->
<br><br><br>
.caption[Fig. 10. Qualitative evaluation of the various components via ablation studies on Forest2]

<!-- Image/Table Placeholder -->
<br><br><br>
.caption[Table 8. Ablation results]
...
<!-- Image/Table Placeholder -->
<br><br><br>
.caption[Table 7. Impact of the anchors on Forest2]
